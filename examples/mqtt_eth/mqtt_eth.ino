/**
   This example shows an asynchronous usage of the Ethernet on the
   Sequent Microsystems ESP32 Raspberry Pi Alternative card
   Based on and modified from ESPAsyncWebServer (https://github.com/me-no-dev/ESPAsyncWebServer)
  and from Khoi Hoang's https://github.com/khoih-prog/AsyncWebServer_ESP32_W5500
*/
...
String data = "Hello from MQTTClient_Basic on Sequent Microsistems ESP32 PI Alternative";
